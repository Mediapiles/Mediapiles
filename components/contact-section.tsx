...
import { ArrowRight, User, Mail, MessageSquare, Clock, RotateCcw, Headphones } from "lucide-react"
...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-dark to-accent/10">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        >
          ...
          <p className="text-xl text-light/80 mb-12 max-w-3xl mx-auto">
            Get professional, scroll-stopping videos tailored for your brand. Starting at zero.
          </p>
          <Button
            size="lg"
        ...
        >
          <div className="text-center mb-8">
            <h3 className="text-2xl md:text-3xl font-bold text-light mb-2">Let's Create Something Viral</h3>
            <p className="text-light/70">Tell us about your project and we'll make it happen</p>
          </div>
